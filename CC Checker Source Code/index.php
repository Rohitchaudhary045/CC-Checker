...
<html class="loading">
  <head>
	...
	<meta charset="UTF-8">
  	...
  	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css" integrity="sha384-kJ3v8CLa8LlLXTxV6Vvb0KBb4lM/+lWd60AuweD6v3/TdNnqlHIsb4DmRbI/OrjJ" crossorigin="anonymous">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">    
    <title>Hackcyberverse.in Checker</title>
	<link rel="icon" type="image/ico" href="faviconico.ico"/>
  ...
  <div class="content-body">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>Hackcybervers's Checker</strong></h4>

					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CARDS HERE"></textarea>
					<textarea rows="1" class="form-control text-center" style="width: 70%; float: left ;"  id="sec" placeholder="cc_live_xxxxxx"></textarea>
    ...
    <option </option>
                ...
                <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur0.5.php">Stripe Charge: €0.5</option>
...
<footer>
  <p>Follow us on <br> <a href="https://www.instagram.com/hackcyberverse.in" <i class="fa fa-instagram" aria-hidden="true"></i>  @Hackcyberverse.in</a></p>
</footer>
<script>
...
swalWithBootstrapButtons.fire({
  title: "Welcome", 
  text: "Do You Want Contact The Devloper",
  icon: 'warning',
...
function RedirectUrl(){    
       window.location.href ="https://www.instagram.com/hackcyberverse.in";
    }
